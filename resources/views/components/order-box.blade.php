...
<div class="p-2 text-white">
    ...
    <div class="hidden lg:block mt-0 lg:mt-2 bg-white p-2 rounded-t-lg dark:bg-gray-800  text-gray-950 dark:text-gray-200">

        <div
            class="items-center my-1 bg-gray-100 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-gray-700">
            {{ $order->creator->name }}
        </div>
        ...
        @if (!$order->in_progress)
            <div x-data={}
                class="flex items-center my-1 bg-gray-100 text-xs font-medium p-0 rounded dark:bg-gray-700">
        ...
        @if ($order->order_description)
            <div
                class="flex items-center my-1 bg-gray-100 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-gray-700">
    ...
    <div class="hidden lg:flex items-center justify-between w-full mt-px text-xs font-medium bg-white dark:bg-gray-800 p-2 rounded-b-lg text-gray-950 dark:text-gray-200">
