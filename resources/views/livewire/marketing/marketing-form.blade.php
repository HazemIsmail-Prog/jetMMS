            ...
            <form wire:submit="save">
                ...
                <div class=" space-y-3">
                    ...
                    <div>
                        ...
                        <x-input required class="w-full py-0" wire:model="form.phone" autocomplete="off" type="number"
                            id="phone" />
                    ...
                    <div>
                        ...
                        <x-select required class="w-full py-0" wire:model="form.type" autocomplete="off" type="text"
                            id="type">
                            <option value="">---</option>
