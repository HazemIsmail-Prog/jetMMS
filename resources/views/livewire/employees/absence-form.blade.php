                ...
                <form wire:submit="save">
                    ...
                    <div class=" space-y-3">
                        ...
                        <div>
                            ...
                            <x-input class="w-full py-0" wire:model.live="form.deduction_days" autocomplete="off" type="text"
                                id="deduction_days" />
                        ...
                        <div>
                            ...
                            <x-input class="w-full py-0" wire:model="form.deduction_amount" autocomplete="off" type="text"
                                id="deduction_amount" />
