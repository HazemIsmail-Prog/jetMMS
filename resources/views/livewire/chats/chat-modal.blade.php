                    ...
                    <div class="flex flex-col flex-1 border border-gray-200 dark:border-gray-700 rounded-lg">
                        @if ($selectedUser)
                            ...
                            <div id="messages" class=" flex-1 overflow-scroll hidden-scrollbar p-4 space-y-4">
                                @foreach ($this->selectedMessages as $message)
                                    <div
                                        ...
                                        <div class=" self-end flex flex-col {{ $message->read && $message->sender_user_id == auth()->id() ? 'text-blue-600' : '' }}"
                            ...
                            <div
                                ...
                                <x-input id="message" wire:keydown.enter="send" wire:model="message"
                                    class="w-full text-start" placeholder="{{ __('messages.write_your_message') }}" />
