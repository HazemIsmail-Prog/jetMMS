            ...
            <form wire:submit.prevent="save" wire:loading.class="opacity-50">
                <div class=" space-y-3">
                    <div>
                        ...
                        <x-input class="w-full" type="text" wire:model="form.name_ar" id="name_ar" dir="rtl" />
                        <x-input-error for="form.name_ar" />
                    </div>
                    <div>
                        <x-label for="name_en">{{ __('messages.name_en') }}</x-label>
                        <x-input class="w-full" type="text" wire:model="form.name_en" id="name_en" dir="ltr" />
                    ...
                    <div>
                        ...
                        <div class="p-2 border dark:border-gray-700 rounded-lg">
                            ...
                            <x-label for="role-{{ $role->id }}" class="flex items-center">
                                <x-checkbox value="{{ $role->id }}" wire:model="form.roles" id="role-{{ $role->id }}" />
