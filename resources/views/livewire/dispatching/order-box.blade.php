    ...
    <div class="mt-2">
        ...
        @if (!in_array($order->status_id, [3, 7]))
            <div
                ...
                <x-select wire:model.live="change_order_technician.{{ $order->id }}.technician_id"
                    class="border-none w-full focus:ring-0 bg-gray-100 text-gray-800 text-xs font-medium p-0 rounded dark:bg-gray-700 dark:text-gray-400 ">
