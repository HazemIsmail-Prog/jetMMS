<div>
    ...
    <div wire:loading.class="hidden">
        ...
        <div class="my-5">
            <h2
                class="mb-2 font-semibold text-xl flex gap-3 items-center text-gray-800 dark:text-gray-200 leading-tight">
                {{ $department->name }}
            </h2>
            ...
            <x-table>
                ...
                <x-thead>
                    ...
                    <tr>
                        ...
                        <x-borderd-th class="!w-1/12">{{ __('messages.required_services_amount_target') }}
                        </x-borderd-th>
                ...
                <tbody>
                    ...
                    <x-tr>
                        ...
                        <x-borderd-td>{{ $servicesAfterDiscount == 0 ? '-' : number_format($servicesAfterDiscount,3) }}
                        </x-borderd-td>
                        <x-borderd-td>{{ number_format($requiredServicesAmountTarget,3) }}</x-borderd-td>
                        <x-borderd-td>{{ $servicesAmountShortage == 0 ? '-' : number_format($servicesAmountShortage,3)
                            }}</x-borderd-td>
                    ...
                    <tr class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-600 dark:text-gray-400">
                        ...
                        <x-borderd-th>{{ $servicesAfterDiscount == 0 ? '-' : number_format($servicesAfterDiscount,3) }}
                        </x-borderd-th>
                        <x-borderd-th>{{ number_format($requiredServicesAmountTarget,3) }}</x-borderd-th>
                        <x-borderd-th>{{ $servicesAmountShortage == 0 ? '-' : number_format($servicesAmountShortage,3)
                            }}</x-borderd-th>
