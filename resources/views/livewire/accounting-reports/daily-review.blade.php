    ...
    <div class=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-3 no-print">
        ...
        <div class="my-5">
            ...
            <x-table>
                <x-thead>
                    <tr>
                        <x-th class="border border-gray-300 dark:border-gray-700" rowspan="2" colspan="2">{{ __('messages.department') }}</x-th>
                ...
                <tbody>
                    ...
                    @endphp
                        <tr class="text-xs text-gray-700 uppercase bg-gray-300 dark:bg-gray-700 dark:text-gray-400">
                            <x-th colspan="2" class="border border-gray-300 dark:border-gray-700 !whitespace-normal">{{ $department->name }}</x-th>
                ...
                <x-tfoot>
                    <tr>
                        <x-th colspan="2" class="border border-gray-300 dark:border-gray-700">{{ __('messages.grand_total') }}</x-th>
