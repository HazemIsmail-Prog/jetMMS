...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['name' => 'orders_attachments_list',       'section_name_ar' => 'العمليات',        'section_name_en' => 'operations',                  'desc_ar' => 'عرض مرفقات الطلب',                                                'desc_en' => 'Orders Attachments List'],
            ['name' => 'orders_attachments_create',     'section_name_ar' => 'العمليات',        'section_name_en' => 'operations',                  'desc_ar' => 'اضافة مرفق للطلب',                                                'desc_en' => 'Orders Attachments Create'],
            ['name' => 'orders_attachments_update',     'section_name_ar' => 'العمليات',        'section_name_en' => 'operations',                  'desc_ar' => 'تعديل مرفق الطلب',                                                'desc_en' => 'Orders Attachments Update'],
            ['name' => 'orders_attachments_delete',     'section_name_ar' => 'العمليات',        'section_name_en' => 'operations',                  'desc_ar' => 'حذف مرفق الطلب',                                                  'desc_en' => 'Orders Attachments Delete'],
